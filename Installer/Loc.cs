...
public static class Loc
{
    ...
    private static readonly Dictionary<string, Dictionary<string, string>> Texts = new()
    {
        [German] = new Dictionary<string, string>
        {
            ...
            ["PluginNotEnabledYet1"] = "Hinweis: Das Plugin ist als Ladeort eingetragen, aber noch nicht als",
            ["PluginNotEnabledYet2"] = "aktiviert markiert (das legt Dalamud erst beim ersten Start an). Starte",
            ["PluginNotEnabledYet3"] = "das Spiel EINMAL, beende es, und führe diesen Installer noch einmal aus –",
            ["PluginNotEnabledYet4"] = "dann wird es scharf geschaltet.",
            ["PluginsRegisteredNotEnabledReturn"] = "Plugins eingetragen, aber noch nicht aktiviert – Spiel einmal starten und Installer erneut ausführen.",
        ...
        [English] = new Dictionary<string, string>
        {
            ...
            ["PluginNotEnabledYet1"] = "Note: The plugin is registered as a load location, but not yet",
            ["PluginNotEnabledYet2"] = "marked as enabled (Dalamud only creates that on first start). Start",
            ["PluginNotEnabledYet3"] = "the game ONCE, exit it, and run this installer again –",
            ["PluginNotEnabledYet4"] = "then it will be activated.",
            ["PluginsRegisteredNotEnabledReturn"] = "Plugins registered but not yet enabled – start the game once and run the installer again.",
