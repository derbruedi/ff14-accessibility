...
public sealed class Plugin : IDalamudPlugin
{
    ...
    private const string PluginVersion    = "5.88";
    private const string PluginVersionTag = "Einstellungen: richtige Beschriftungen, keine Doppelansagen, keine Bildfrequenz-Flut";
