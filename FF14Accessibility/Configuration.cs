...
public sealed class Configuration : IPluginConfiguration
{
    ...
    public string KeyCategory     = "Strg+N";           // Objekt-Browser: Kategorie wechseln
    public string KeyWalkGuide    = "Strg+Umschalt+N";  // Gehhilfe an/aus (Richtungsansagen beim Laufen)
